            ...
            try:
                ...
                for result in response:
                    if result.assertions:
                        ...
                        self.results['total'] = "0/0"
                        self.results['positives'] = 0
                        self.results['PolyScore'] = "-"
                        self.results['permalink'] = "-"
                        self.results['message'] = "Hash not found"
                    break
                ...
                self.results['PolyScore'] = "-"
                self.results['permalink'] = "-"
                self.results['message'] = "An error has occurred: {0}".format(error)
            finally:
                return True
